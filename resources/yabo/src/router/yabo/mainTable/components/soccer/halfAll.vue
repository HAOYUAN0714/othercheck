                ...
                >
                  <div class="banner subTitle">
                    ...
                    <div class="multipleTitle">
                      <div class="betType">
                        <span colspan="1">{{$t('TEXT_HOME_S')}}{{$t('TEXT_HOME_S')}}</span>
                        <span colspan="1">{{$t('TEXT_HOME_S')}}{{$t('TEXT_DRAW_S')}}</span>
                        <span colspan="1">{{$t('TEXT_HOME_S')}}{{$t('TEXT_AWAY_S')}}</span>
                        <span colspan="1">{{$t('TEXT_DRAW_S')}}{{$t('TEXT_HOME_S')}}</span>
                        <span colspan="1">{{$t('TEXT_DRAW_S')}}{{$t('TEXT_DRAW_S')}}</span>
                        <span colspan="1">{{$t('TEXT_DRAW_S')}}{{$t('TEXT_AWAY_S')}}</span>
                        <span colspan="1">{{$t('TEXT_AWAY_S')}}{{$t('TEXT_HOME_S')}}</span>
                        <span colspan="1">{{$t('TEXT_AWAY_S')}}{{$t('TEXT_DRAW_S')}}</span>
                        <span colspan="1">{{$t('TEXT_AWAY_S')}}{{$t('TEXT_AWAY_S')}}</span>
                      </div>
                    </div>
                    <div class="starColumn"></div>
                  </div>
                  ...
                  <div class="table eventItem">
                    ...
                    <div class="oddsTable" v-if="event['oddsList'][1][betType]">
                      <div
                        class="oddsColumn"
                        v-for="oddsItem in event['oddsList'][1][betType][1]"
                        :key="oddsItem.WagerSelectionId"
                      >
                        <oddsItem :oddsSet="oddsItem" />
                      </div>
