...
import Layout from '@/layout/bblivem/index.vue'
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: '/moreSportToday',
        name: 'moreSportToday',
        component: () => import('@/views/bblivem/today/moreSport')
      },
      {
        path: '/moreSportFuture',
        name: 'moreSportFuture',
        component: () => import('@/views/bblivem/breakfast/moreSport')
      },
      {
        path: '/detail/:sportId/:gameId/:routername/:Market/:currentPage',
        name: 'sportDetail',
        component: () => import('@/views/bblivem/sportDetail')
      }
      //
    ]
  },
