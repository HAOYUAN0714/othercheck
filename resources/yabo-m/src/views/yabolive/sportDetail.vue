...
import scoreBoard from '../../layout/yabolive/components/scoreBoard'
import { getSelectedEventInfo } from '@/api/yabolive'
import loading from '@/layout/components/liveloading'
import template1 from '@/layout/yabolive/components/moreGame/template1'
import template2 from '@/layout/yabolive/components/moreGame/template2'
import template3 from '@/layout/yabolive/components/moreGame/template3'
import template4 from '@/layout/yabolive/components/moreGame/template4'
import template5 from '@/layout/yabolive/components/moreGame/template5'
import avoid from '@/layout/yabolive/components/Avoid'
...
.container {
  ...
  .playing {
    ...
    &::-webkit-scrollbar-track {
      background-color: transparentize(#303133, 0.7);
    }
    &::-webkit-scrollbar-thumb {
      border-radius: 5px;
      background: transparentize(#303133, 0.5);
      box-shadow: inset 0 0 6px #303133;
    }
    li {
      margin: 0px 10px;
      padding: 0 10px;
