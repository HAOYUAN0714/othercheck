...
import { getFutureGame, getLiveBasicData } from '@/api/yabolive'
...
import navbar from '@/layout/yabolive/components/navbar/moreGameNavbar'
...
.dashboard {
  ...
  &-choose {
    ...
    .active {
      ...
      color: #f4bf63;
      border-bottom: 2px solid #f4bf63;
      // border-radius: 5px;
    }
